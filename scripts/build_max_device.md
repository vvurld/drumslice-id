...
The repository commits `dist/DrumSLICE ID.amxd` for convenient development reinstallation. It is expected to use the separately installed `SliceLabeler` package and is not, by itself, a complete end-user installation.
